  ...
  return (
    <main className="">
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col ">
        ...
        <p className="text-center text-2xl font-semibold">Run your agency, in one place</p>
        ...
        <div className={"flex justify-center items-center relative md:mt-[-20px]"}>
          <Image src={"/assets/preview.png"} alt={"banner image"} height={1200} width={1200}
      ...
      <section className={"flex justify-center items-center flex-col gap-4 md:mt-20"}>
        ...
        <p className={"text-muted-foreground text-center"}>
          Our Straight forward pricing plans are tailed to meet your needs. If {" you're"} not <br/> ready to commit you
          can get started for free.
        </p>
        <div className="flex justify-center gap-4 flex-wrap mt-6">
          {pricingCards.map((pricingCard) => (
            // WIP: Wire up free product from stripe.
            <Card key={pricingCard.title}
                  className={clsx('w-[300px] flex flex-col justify-between', {'border-2 border-primary': pricingCard.title === "Unlimited Saas"})}
            >
              <CardHeader>
              ...
              <CardFooter className={"flex flex-col items-start gap-4"}>
                ...
                <Link href={`/agency?plan=${pricingCard.priceId}`} className={clsx('w-full text-center bg-primary' +
                  ' p-2 rounded-md', {'!bg-muted-foreground': pricingCard.title !== 'Unlimited Saas'})}>
                  Get Started
                </Link>
              </CardFooter>
            </Card>
